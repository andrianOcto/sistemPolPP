...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
                  ...
                  <table id="example2" class="table table-hover table-striped">
                    ...
                    <tbody>
                      ...
                      <tr @if($i==0) class = "success"
                        ...
                        <td align="center">
                          <a class="btn btn-warning" href="#modal-updateProgram{{$program->id}}" data-toggle="modal" data-target="#modal-updateProgram{{$program->id}}">
                              <i class="fa fa-edit fa-lg"></i> Update
                          </a>
                          <a class="btn btn-danger"  href="#modal-deleteProgram{{$program->id}}" data-toggle="modal" data-target="#modal-deleteProgram{{$program->id}}">
      ...
      @foreach($programs as $program)
      <!-- Modal Update User -->
      <div class="modal fade" id="modal-updateProgram{{$program->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
