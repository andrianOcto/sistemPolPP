...
class RekapRealisasiKeseluruhanController extends Controller{
    public function getIndex(){
        $data['page_title'] = 'Rekapitulasi Realisasi Keseluruhan';
        
        if(Session::get("role","default")=="master")
            return redirect('/');
        else
            return view('/laporan/rekaprealisasiseluruh')->with($data);
    }
    ...
    public function exportToExcel(){
        ...
        Excel::create('Rekap Realisasi Keseluruhan', function($excel) use($data){
